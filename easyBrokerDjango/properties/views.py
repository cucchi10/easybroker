...
from properties.controllers.contactRequests import ContactRequests
from properties.forms.forms import ContactForm
from properties.controllers.connectorProperties import ConnectorProperties

API_KEY = "l7u502p8v46ba3ppgvj5y2aad50lb9"
connector = ConnectorProperties(API_KEY)
connector_contact_request = ContactRequests(API_KEY)

def index(request, page = 1):

    response = connector.get_properties_page(page = page, limit = 20, statuses = ['published'])
